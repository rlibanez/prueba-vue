<template>
    <div class="container">
        <AuthorTable :authors="authors" @author-selected="handleAuthorSelected" @author-deleted="handleAuthorDeleted" />
    </div>
</template>
    ...
    methods: {
        ...
        async handleAuthorSaved(updatedAuthor) {
            ...
            try {
                ...
                toast.success(`Author with id ${updatedAuthorData.id} updated successfully.`);
            } catch (error) {
